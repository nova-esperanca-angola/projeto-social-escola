...
<section id="bento-impacto" class="space-y-3 scroll-mt-20">
  ...
  <div class="grid grid-cols-2 gap-3">
    <!-- Metric 1: Alunos Matriculados -->
    <div class="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-4 flex flex-col justify-between shadow-sm">
      ...
      <div>
        <div class="font-metric-stat text-metric-stat text-primary leading-none text-2xl sm:text-3xl font-extrabold">93</div>
    ...
    <div class="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-4 flex flex-col justify-between shadow-sm">
      ...
      <div>
        <div class="font-metric-stat text-metric-stat text-secondary leading-none text-2xl sm:text-3xl font-extrabold">10</div>
        <div class="font-label-md text-label-md text-on-background font-bold mt-1 text-sm">Colaboradores</div>
        <div class="font-body-sm text-body-sm text-on-surface-variant mt-0.5 text-xs">5 educadoras e equipe</div>
      </div>
    </div>

    <!-- Metric 4: Merenda Garantida -->
    <div class="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-4 flex flex-col justify-between shadow-sm">
      ...
      <div>
        <div class="font-metric-stat text-metric-stat text-nutrition-green leading-none text-2xl sm:text-3xl font-extrabold">100%</div>
        <div class="font-label-md text-label-md text-on-background font-bold mt-1 text-sm">Merenda Garantida</div>
        <div class="font-body-sm text-body-sm text-on-surface-variant mt-0.5 text-xs">Pão fresco, sopa e feijão</div>
      </div>
    </div>
  </div>
</section>
